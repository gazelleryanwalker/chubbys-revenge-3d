...
# 6: feature greps
for term in "GOD MODE" "AUTO-LOCK" "MOVES" "head_split" "LEVELS" "FARMLAND" "DOWNTOWN" "stache" "TAUNTS" "board" "PAUSED" "OUTFITS" "WEAPONS" "set_level" "horse_fp" "caption" "flash_red" "lifetime_kills" "S.INTRO" "spawn_drop" "touch_mode" "view_mode" "killcam" "joy_vec" "try_knock"; do
